/**
  ...
  ******************************************************************************
  */
#ifndef AI_COMMANDS_MODEL_H
#define AI_COMMANDS_MODEL_H

#include "commands_model_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_COMMANDS_MODEL_MODEL_NAME          "commands_model"
#define AI_COMMANDS_MODEL_ORIGIN_MODEL_NAME   "model"

/******************************************************************************/
#define AI_COMMANDS_MODEL_ACTIVATIONS_ALIGNMENT   (4)
#define AI_COMMANDS_MODEL_INPUTS_IN_ACTIVATIONS   (4)
#define AI_COMMANDS_MODEL_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_COMMANDS_MODEL_IN_NUM        (1)

AI_DEPRECATED
#define AI_COMMANDS_MODEL_IN \
  ai_commands_model_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_COMMANDS_MODEL_IN_SIZE { \
  AI_COMMANDS_MODEL_IN_1_SIZE, \
}
#define AI_COMMANDS_MODEL_IN_SIZE_BYTES { \
  AI_COMMANDS_MODEL_IN_1_SIZE_BYTES, \
}
#define AI_COMMANDS_MODEL_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_COMMANDS_MODEL_IN_1_CHANNEL     (33)
#define AI_COMMANDS_MODEL_IN_1_SIZE        (33)
#define AI_COMMANDS_MODEL_IN_1_SIZE_BYTES  (132)

/******************************************************************************/
#define AI_COMMANDS_MODEL_OUT_NUM       (1)

AI_DEPRECATED
#define AI_COMMANDS_MODEL_OUT \
  ai_commands_model_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_COMMANDS_MODEL_OUT_SIZE { \
  AI_COMMANDS_MODEL_OUT_1_SIZE, \
}
#define AI_COMMANDS_MODEL_OUT_SIZE_BYTES { \
  AI_COMMANDS_MODEL_OUT_1_SIZE_BYTES, \
}
#define AI_COMMANDS_MODEL_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_COMMANDS_MODEL_OUT_1_CHANNEL     (3)
#define AI_COMMANDS_MODEL_OUT_1_SIZE        (3)
#define AI_COMMANDS_MODEL_OUT_1_SIZE_BYTES  (12)

/******************************************************************************/
#define AI_COMMANDS_MODEL_N_NODES (4)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup commands_model
...
AI_DEPRECATED
AI_API_ENTRY
ai_bool ai_commands_model_get_info(
 ...
 */
AI_API_ENTRY
ai_bool ai_commands_model_get_report(
  ai_handle network, ai_network_report* report);
 ...
 */
AI_API_ENTRY
ai_error ai_commands_model_get_error(ai_handle network);
 ...
 */
AI_API_ENTRY
ai_handle ai_commands_model_destroy(ai_handle network);
 ...
 * @ref ai_commands_model_create. Both the activations memory buffer 
 ...
 * using @ref ai_commands_model_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_error ai_commands_model_create_and_init(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_commands_model_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_commands_model_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_COMMANDS_MODEL_*
 * defines into file @ref commands_model.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_commands_model_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_COMMANDS_MODEL_H */
