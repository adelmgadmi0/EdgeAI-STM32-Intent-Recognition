...
ai_buffer g_commands_model_data_map_activations[AI_COMMANDS_MODEL_DATA_ACTIVATIONS_COUNT] = {
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 196, 1, 1),
    196, NULL, NULL),    /* heap_overlay_pool */
  };
ai_buffer g_commands_model_data_map_weights[AI_COMMANDS_MODEL_DATA_WEIGHTS_COUNT] = {
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 2380, 1, 1),
    2380, NULL, s_commands_model_weights_array_u64),   /* weights_array */
  };


/*!
 * @brief Get network activations buffer initialized struct.
 * @ingroup commands_model_data
 ...
 */
AI_API_ENTRY
ai_bool ai_commands_model_data_params_get(ai_network_params* params)
{
  if (!params) return false;
  
  const ai_buffer_array map_activations = 
    AI_BUFFER_ARRAY_OBJ_INIT(AI_FLAG_NONE, AI_COMMANDS_MODEL_DATA_ACTIVATIONS_COUNT, g_commands_model_data_map_activations);
  
  const ai_buffer_array map_weights = 
    AI_BUFFER_ARRAY_OBJ_INIT(AI_FLAG_NONE, AI_COMMANDS_MODEL_DATA_WEIGHTS_COUNT, g_commands_model_data_map_weights);
